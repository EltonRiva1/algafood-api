...
public class CozinhaController {
	...
	public List<CozinhaModel> listar() {
		List<Cozinha> todasCozinhas = this.cozinhaRepository.findAll();
		return this.cozinhaModelAssembler.toCollectionModel(todasCozinhas);
	}
	...
	public CozinhaModel adicionar(@RequestBody @Valid CozinhaInput cozinhaInput) {
		Cozinha cozinha = this.cozinhaInputDisassembler.toDomainObject(cozinhaInput);
	...
	public CozinhaModel atualizar(@PathVariable Long cozinhaId, @RequestBody @Valid CozinhaInput cozinhaInput) {
		...
		cozinhaAtual = this.cadastroCozinhaService.salvar(cozinhaAtual);
		return this.cozinhaModelAssembler.toModel(cozinhaAtual);
	}
