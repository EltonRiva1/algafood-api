...
public class FormaPagamentoController {
	...
	public List<FormaPagamentoModel> listar() {
		List<FormaPagamento> todasFormasPagamentos = this.formaPagamentoRepository.findAll();
		return this.formaPagamentoModelAssembler.toCollectionModel(todasFormasPagamentos);
	}
	...
	public FormaPagamentoModel adicionar(@RequestBody @Valid FormaPagamentoInput formaPagamentoInput) {
		FormaPagamento formaPagamento = this.formaPagamentoInputDisassembler.toDomainObject(formaPagamentoInput);
