...
-- Tabelas auxiliares necessárias para FK
...
CREATE TABLE IF NOT EXISTS cidade (
    id bigint not null auto_increment,
    nome varchar(80) not null,
    estado varchar(2) not null, -- Ex: SP, RJ
    primary key (id)
) engine=InnoDB default charset=utf8;

-- Tabela principal que depende de cozinha e cidade
...
-- Tabelas de relacionamento e produtos
